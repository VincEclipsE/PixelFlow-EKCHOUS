...
import com.thomasdiewald.pixelflow.java.imageprocessing.filter.BoxBlur;
...
/** Two-pass separable box blur — cheaper than Gaussian for similar radius. */
public final class BoxBlurNode extends AbstractNode {

    public static final String TYPE_ID = "pf.filter.BoxBlur";
    ...
    @Override public void init(GraphContext ctx) {
        blur = new BoxBlur(ctx.pixelFlow());
    }
